...
export const PATRON_PLAN_OFFERS: Record<PatronPlanKey, PatronPlanOffer> = {
  none: {
    ...
    commissionLabel: '+ 10% du montant total de la mission',
  ...
  pro: {
    ...
    commissionLabel: '+ 8% du montant total de la mission',
    ctaLabel: 'Choisir Pro',
    contextLabel: 'Adapté à un usage régulier',
    recommended: true,
  ...
  pro_plus: {
    ...
    commissionLabel: '+ 5% du montant total de la mission',
    ctaLabel: 'Choisir Pro+',
    contextLabel: 'Offre premium',
