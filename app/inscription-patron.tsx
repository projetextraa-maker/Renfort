...
export default function InscriptionPatron() {
  ...
  const handleRecoverExistingPatronAccount = async () => {
    ...
    if (accountState.role && accountState.role !== 'patron') {
      setSubmitError("Cet email est dÃ©jÃ  associÃ© Ã  un compte serveur. Connectez-vous avec le bon espace.")
      Alert.alert(
        'Compte dÃ©jÃ  existant',
        "Cet email est dÃ©jÃ  associÃ© Ã  un compte serveur. Connectez-vous depuis l'espace serveur.",
        [
          { text: 'Annuler', style: 'cancel' },
