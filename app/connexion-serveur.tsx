...
export default function ConnexionServeur() {
  ...
  const handleConnexion = async () => {
    ...
    if (error || !data.user) {
      if (error) console.error('connexion serveur signIn error', error)
    ...
    if (!profileSync.ok) {
      console.error('connexion serveur profile sync error', profileSync)
    }
  ...
  return (
    <View style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity style={styles.registerLink} onPress={() => router.push('/inscription-serveur')}>
