...
const s = StyleSheet.create({
  ...
  countNum: { fontSize: 20, fontWeight: '800', color: '#FFFFFF', letterSpacing: -0.5 },
  countLbl: { fontSize: 9, color: '#FFFFFF', marginTop: 1 },
  globalBtn: {
  ...
  dayRowActive: { borderColor: C.accentBd, backgroundColor: '#FBFDFB' },
  dayBtn: {
    width: 48,
    height: 48,
    borderRadius: 12,
  ...
  dayBtnActive: { backgroundColor: C.accentSoft, borderColor: C.accentBd },
  dayTxt: { fontSize: 12, fontWeight: '800', color: C.textSoft },
  dayTxtActive: { color: C.accent },
  ...
  slotTxtActive: { color: C.accent },
  slotTxtLinkedActive: { color: C.accent },
